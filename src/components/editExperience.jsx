...
const EditExperienceForm = ({closeExpPopup,id}) => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3200/api/users/experience', jsonFormData, {
        headers: {
  ...
  const handleDelete = async(e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3200/api/users/delete-experience', jsonFormData, {
        headers: {
          'Content-Type': 'application/json'
        },
        withCredentials: true
