...
import SearchIcon from "./searbar";
...
function Header() {
   ...
   <div className="hidden md:flex w-full">< SearchIcon/></div> 
    <div className="flex flex-row place-items-center gap-10 hidden md:flex"> 
            {/* Youtube */}
            <Link
              href="https://youtube.com/@DSCNITJ"
              rel="noreferrer"
              target="_blank"
            >
              <svg
                className="p-1 size-6  fill-white ease-in duration-200 hover:fill-red-600"
                width="28"
                height="21"
                viewBox="0 0 28 21"
                fill="none"
            ...
            {/* Facebook */}
            <Link
              href="https://www.facebook.com/alokthakur/"
              rel="noreferrer"
              target="_blank"
            >
              <svg
                className="p-1 size-6 fill-white ease-in duration-200 hover:fill-blue"
                width="12"
                height="21"
                viewBox="0 0 12 21"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M11.4737 0.546387H8.47935C7.15574 0.546387 5.88634 1.08028 4.95041 2.03062C4.01447 2.98094 3.48867 4.26988 3.48867 5.61385V8.65433H0.494263V12.7083H3.48867V20.8163H7.48122V12.7083H10.4756L11.4737 8.65433H7.48122V5.61385C7.48122 5.34506 7.58637 5.08727 7.77357 4.8972C7.96075 4.70714 8.21463 4.60036 8.47935 4.60036H11.4737V0.546387Z" />
              </svg>
            </Link>
            {/* Twitter */}
            <Link
              href="https://twitter.com/alokthakur490"
              rel="noreferrer"
              target="_blank"
            >
              <svg
                className="p-1 size-6 fill-white ease-in duration-200 hover:fill-[#1DA1F2]"
                width="28"
                height="22"
                viewBox="0 0 26 21"
                fill="none"
