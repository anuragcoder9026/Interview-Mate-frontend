    ...
    <div className="flex items-center justify-center relative w-full">
      ...
      <div className="flex flex-col  w-full">
        <div className="flex justify-between">
          ...
          {typing ? <p className="text-green text-sm">Typing...</p>:<p className="text-sm text-gray-400">{lastMessage?.content?.image ? <span className="flex"><FaRegImages className="mr-2 mt-1"/> Image </span>: <span className={`truncate block w-[215px] sm:w-[245px] overflow-hidden text-ellipsis whitespace-nowrap`}>{lastMessage?.content?.text}</span>}</p>}
