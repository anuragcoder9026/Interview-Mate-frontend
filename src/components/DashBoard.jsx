      ...
      >
        ...
        <header className="mb-6">
          ...
          <div className="mt-4 flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-6">
            <a
              href="#"
              className="p-3 bg-blue-900 rounded-xl shadow-md text-lg hover:text-indigo-400 font-medium"
            >
              Dashboard
            </a>
            <a
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800 p-4 lg:p-6 rounded-lg shadow-lg">
              <h3 className="text-lg lg:text-xl font-bold text-indigo-400 mb-4">
                Quizzes
              </h3>
            ...
            <div className="bg-gray-800 p-4 lg:p-4 rounded-lg shadow-lg">
              ...
              <ul>
                <li className="flex mb-2">
                  <span className="font-bold text-green-400 mr-3">Quiz 1</span>
                  <ScrollChart value={85} color={"orange"} /> 85%
                </li>
                <li className="flex mb-2">
                  <span className="font-bold text-green-400 mr-3">Quiz 2</span>
                  <ScrollChart value={45} color={"green"} /> 90%
                </li>
                <li className="flex">
                  <span className="font-bold text-green-400 mr-3">Quiz 3</span>
                  <ScrollChart value={75} color={"blue"} /> 88%
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-800 p-4 lg:p-6 rounded-lg shadow-lg">
              ...
              <ul>
                <li className="flex mb-2 w-full">
                  <span className="font-bold text-sm text-green-400 mr-3">
                    Interview 1
                  </span>
                  <ScrollChart value={9 * 10} color={"red"} /> 9/10
                </li>
                <li className="flex mb-2 w-full">
                  <span className="font-bold text-sm text-green-400 mr-3">
                    Interview 2
                  </span>
                  <ScrollChart value={7 * 10} color={"yellow"} /> 7/10
                </li>
                <li className="flex w-full">
                  <span className="font-bold text-sm text-green-400 mr-3">
                    Interview 3
                  </span>
                  <ScrollChart value={8 * 10} color={"violet"} /> 8/10
                </li>
              </ul>
            </div>
          </div>
