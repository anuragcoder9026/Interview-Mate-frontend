...
const EditEducationForm = ({closeEduPopup,id}) => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3200/api/users/education', jsonFormData, {
        headers: {
  ...
  const handleDelete = async(e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3200/api/users/delete-education', jsonFormData, {
        headers: {
          'Content-Type': 'application/json'
        },
        withCredentials: true
